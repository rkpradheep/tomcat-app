...
public class TableConstantGenerator
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		Connection connection = DriverManager.getConnection("jdbc:" + dbServer + "://localhost:" + dbPort   + "/" + schemaName + "?useSSL=no", userName, password );
		...
		// Replace your VelocityEngine initialization code with this
		...
		for(TableMeta tableMeta : tableMetaList)
		{
			...
			File file = new File(System.getenv("TOMCAT_APP") + "/table-constants/build/temp/" + packageName.replaceAll("\\.", "/"));
			file.mkdirs();
