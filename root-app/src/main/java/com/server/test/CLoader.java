...
public class CLoader
{
	public static String get() throws Exception
	{
		...
		//URLClassLoader urlClassLoader = new URLClassLoader(new URL[]{new URL("file:" + com.server.framework.common.Util.HOME_PATH + "/build/webapps/ROOT/WEB-INF/lib/com.server.test.DynamicCP.jar")}, com.server.test.CLoader.class.getClassLoader());
		ClassLoader classLoader = new ClassLoader()
		{
			...
			protected Class<?> findClass(String className) throws ClassNotFoundException
			{
				...
				String libPath = Util.HOME_PATH + "/build/webapps/ROOT/WEB-INF/lib/";
